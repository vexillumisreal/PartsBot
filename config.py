...
WEBAPP_URL: str = os.getenv("WEBAPP_URL", "https://bot-1789310714-4055-vexillumisreal.bothost.tech/index.html")
if WEBAPP_URL:
    if not WEBAPP_URL.startswith("http"):
        WEBAPP_URL = f"https://{WEBAPP_URL}"
    if not WEBAPP_URL.endswith(".html") and not WEBAPP_URL.endswith("/"):
        WEBAPP_URL = f"{WEBAPP_URL}/index.html"
    elif WEBAPP_URL.endswith("/"):
        WEBAPP_URL = f"{WEBAPP_URL}index.html"
